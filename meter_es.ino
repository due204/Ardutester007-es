...
// Strings in PROGMEM or in EEprom
...
#if defined(LANG_SPANISH)   // español
  const unsigned char TestRunning[] MEM_TEXT = "probando...";
  const unsigned char BatWeak[] MEM_TEXT = "debil";
  const unsigned char BatEmpty[] MEM_TEXT = "baja!";
  const unsigned char TestFailed2[] MEM_TEXT = "estropeado ";
  ...
  const unsigned char Thyristor[] MEM_TEXT = "Transistor";
  const unsigned char Unknown[] MEM_TEXT = " Desconocido";
  const unsigned char TestFailed1[] MEM_TEXT = "No conocido";
  ...
  #ifdef WITH_SELFTEST
    const unsigned char SELFTEST[] MEM_TEXT = "Autodiagnostico";
    const unsigned char RELPROBE[] MEM_TEXT = "aislar la sonda!";
    const unsigned char ATE[] MEM_TEXT = "Fin de la prueba";
  #endif
#endif
...
void setup()
{
  ...
  pinMode(TestKeyPin, INPUT);
    ...
    lcd_string("TESTER");
    lcd_set_cursor(1, 2);
    lcd_string("DIGITAL ESR");
    lcd_set_cursor(3, 0);
    lcd_string("due204@gmail.com");
  #endif
